...
export const ExternalUPILandingModal: React.FC<ExternalUPILandingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-3 sm:p-4 backdrop-blur-xs animate-fadeIn text-slate-900">
      <div className="bg-white w-full max-w-sm rounded-3xl p-5 shadow-2xl border border-slate-200 relative space-y-4 max-h-[90vh] overflow-y-auto my-auto shrink-0">
        {/* Close Button */}
        <button
          onClick={onClose}
